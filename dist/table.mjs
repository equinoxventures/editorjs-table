    ...
    if (t && t.content) {
      for (let e = 0; e < t.content.length; e++)
        for (let o = 0; o < t.content[e].length; o++) {
          ...
          typeof i == "object" ? (this.setCellContent(e + 1, o + 1, i.content), this.setCellWidth({ row: e + 1, column: o + 1, defaultWidth: i.width })) : this.setCellContent(e + 1, o + 1, t.content[e][o]), this.setCellBackgroundColor(e + 1, o + 1, i.backgroundColor || this.config.defaultBackgroundColor);
        }
      this.adjustColumnWidths();
    }
  }
